...
'Click on the link %(link)s to reset your password': 'Clique na url %(link)s para alterar sua senha',
...
'design': 'projeto',
'Design': 'Design',
'Digite aqui sua mensagem.': 'Digite aqui sua mensagem.',
'DISK': 'DISK',
...
'Enviar': 'Enviar',
'Errors': 'Erros',
'Errors in form, please check it out.': 'Há erros no formulário, por favor confira.',
'Escolha um assunto': 'Escolha um assunto',
...
'no file selected': ' não há arquivo selecionado',
'Not authorized': 'Não autorizado',
'O conteúdo não pode ser vazio.': 'O conteúdo não pode ser vazio.',
...
'Plugins': 'Plugins',
'Por favor selecione uma das opções': 'Por favor selecione uma das opções',
...
'Tamanho máximo de 16 caracteres.': 'Tamanho máximo de 16 caracteres.',
